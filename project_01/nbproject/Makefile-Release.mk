...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/project1_3

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/project1_3: ${OBJECTFILES}
...
${OBJECTDIR}/CharacterVectorSortByHair.o: CharacterVectorSortByHair.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CharacterVectorSortByHair.o CharacterVectorSortByHair.cpp

${OBJECTDIR}/CharacterVectorSortByName.o: CharacterVectorSortByName.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CharacterVectorSortByName.o CharacterVectorSortByName.cpp

${OBJECTDIR}/CharacterVectorSortByRace.o: CharacterVectorSortByRace.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CharacterVectorSortByRace.o CharacterVectorSortByRace.cpp

${OBJECTDIR}/CharacterVectorSortBySpeed.o: CharacterVectorSortBySpeed.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CharacterVectorSortBySpeed.o CharacterVectorSortBySpeed.cpp

${OBJECTDIR}/CharacterVectorSortable.o: CharacterVectorSortable.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CharacterVectorSortable.o CharacterVectorSortable.cpp
...
${OBJECTDIR}/LargeFactory.o: LargeFactory.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LargeFactory.o LargeFactory.cpp
...
${OBJECTDIR}/MedFactory.o: MedFactory.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MedFactory.o MedFactory.cpp
